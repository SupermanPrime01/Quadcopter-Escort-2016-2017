...
def check_serial():
	print 'Do you have GPS connected to the serial ports? hit y or n, then enter'
	temp = raw_input()
	if temp == 'y':
		init_serial()
	if temp == 'n':
...
def save_raw():
		...
		line1 = ser1.readline()
		line1_str = str(line1)
    		if(line_str[0] == '3' and line1_str[0] == '3'): # $GPGGA
